            ...
            <nav class="navbar navbar-light navbar-expand-md justify-content-between" style="background-color: #A2D9E7;">
                ...
                <img src="img/logo180.png" alt="" class="navbar-brand" >
                    ...
                    <div class="navbar-collapse collapse dual-nav w-50 order-1 order-md-0">
                        <ul class="navbar-nav ">
                            <li class="nav-item ">
                                <a class="nav-link nav-link-bar" href="about.php" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false" style="position:relative;">
                                                            &emsp;品牌故事&emsp;
                                                            </a>
                            </li>
                            <li class="nav-item dropdown nav-link-bar">
                                <a class="nav-link" href="product1.php" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false" style="position:relative;">
                                &emsp;麵包/蛋糕&emsp;
                                                    </a>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link nav-link-bar" href="market.php" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false" style="position:relative;" >
                                                        &emsp;前往購物&emsp;
                                                    </a>
                            </li>
                            <?php if ($totalRows_rs_success == 0) { // Show if recordset empty ?>
                              <li class="nav-item "> <a class="nav-link" href="login.php" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false"  style="position:relative;"> &emsp;<i class="far fa-user"></i>會員登入&emsp; </a></li>
                          ...
                          <?php if ($totalRows_rs_success > 0) { // Show if recordset not empty ?>
                            ...
                            &emsp;<i class="far fa-user "></i> Hi!<?php echo $totalRows_rs_success['name']; ?>，點我登出&emsp;
                            </a>
                            </li>
                          ...
                          <?php if ($totalRows_rs_success > 0) { // Show if recordset not empty ?>
                                ...
                                <a class="nav-link " href="member.php" id="navbarDropdown " role="button " aria-haspopup="true " aria-expanded="false " >
                                    &emsp;<i class="fas fa-user-tag"></i>會員管理&emsp;
                                </a>
                            </li>
                            <?php } // Show if recordset not empty ?>
